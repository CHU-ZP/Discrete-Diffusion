...
同一个扩散核心也能生成二值 `64^3` 占用网格。下面展示四种条件 subtype 经过连通分量清理后的结果。

<table>
  <tr>
    <td align="center"><img src="results/modelnet10/chair_0.png" alt="生成的椅子体素样本" width="300"><br>chair_0</td>
    <td align="center"><img src="results/modelnet10/sofa_2.png" alt="生成的沙发体素样本" width="300"><br>sofa_2</td>
  </tr>
  <tr>
    <td align="center"><img src="results/modelnet10/bed_0.png" alt="生成的床体素样本" width="300"><br>bed_0</td>
    <td align="center"><img src="results/modelnet10/monitor_1.png" alt="生成的显示器体素样本" width="300"><br>monitor_1</td>
  </tr>
</table>
